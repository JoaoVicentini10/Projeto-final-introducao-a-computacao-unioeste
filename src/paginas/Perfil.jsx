...
function Perfil() {
  ...
  const usuario = {
    ...
    progresso: 75, // Porcentagem de progresso
      ...
      <div className="perfil-topo">
        ...
        <div className="perfil-progresso">
          <div
            ...
            style={{
              background: `conic-gradient(#4caf50 ${usuario.progresso}%, #e0e0e0 ${usuario.progresso}% 100%)`,
            }}
          >
            <div className="progresso-texto">{usuario.progresso}%</div>
          </div>
          <p className="progresso-label">75% das horas completadas</p>
        </div>
      </div>
      ...
      <div className="perfil-detalhes">
        ...
        <div className="perfil-info">
          ...
          <div className="info-item">
            ...
            <span className="info-valor">{usuario.habilidades.join(", ")}</span>
          </div>
        </div>
      </div>
    </div>
